...
export const completeModalVerbsDecks: Deck[] = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        category: 'modal-verbs-complete',
        difficulty: 'A2',
        notes: 'Conjugation: ech wäert, du wäerts, hien/si/hatt wäert, mir wäerten, dir wäert, si wäerten. Example: Ech wäerten kommen (I will come)',
      ...
      },
      {
        ...
        luxembourgish: 'Ech wäerten kommen',
        english: 'I will come',
        pronunciation: 'esh vay-er-ten ko-men',
        category: 'modal-verbs-examples',
        difficulty: 'A2',
